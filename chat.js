...
const predefinedResponses = {
    ...
    whoAreYou: {
    en: "I am Smart Vision AI, an AI assistant created by Team XKINGS. Member: Jeyaram. I can help with image analysis and chat.",
    es: "Soy Smart Vision AI, un asistente de IA creado por Team XKINGS. Miembro: Jeyaram. Puedo ayudar con el análisis de imágenes y el chat.",
    fr: "Je suis Smart Vision AI, un assistant IA créé par Team XKINGS. Membre : Jeyaram. Je peux vous aider avec l'analyse d'images et le chat.",
    de: "Ich bin Smart Vision AI, ein KI-Assistent, der von Team XKINGS erstellt wurde. Mitglied: Jeyaram. Ich kann bei der Bildanalyse und im Chat helfen.",
    hi: "मैं स्मार्ट विजन एआई हूँ, टीम XKINGS द्वारा बनाया गया एक एआई सहायक। सदस्य: जेयराम। मैं छवि विश्लेषण और चैट में मदद कर सकता हूँ।",
    ja: "私はTeam XKINGSによって作成されたAIアシスタント、Smart Vision AIです。メンバー：ジェヤラム。画像分析とチャットを支援できます。",
    zh: "我是Smart Vision AI，一个由Team XKINGS创建的AI助手。成员：Jeyaram。我可以帮助进行图像分析和聊天。",
    ta: "நான் ஸ்மார்ட் விஷன் ஏஐ, XKINGS குழுவால் உருவாக்கப்பட்ட ஒரு AI உதவியாளர். உறுப்பினர்: ஜெயராம். நான் பட பகுப்பாய்வு மற்றும் அரட்டையில் உதவ முடியும்.",
},
    mahi: {
